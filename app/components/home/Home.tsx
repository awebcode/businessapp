        ...
        <div className="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
              ...
              <g style={{ isolation: "isolate" }}>
                <g id="Capa_1" data-name="Capa 1">
                  ...
                  <path
                    ...
                    style={{
                      fill: "none",
                      stroke: "#8382b3;stroke-miterlimit:10;stroke-width:0.992126px",
                    }}
                  />
                  <path
                    ...
                    style={{
                      fill: "none",
                      stroke:
                        "#8382b3;stroke-miterlimit:10;stroke-width:0.992126px;stroke-dasharray:2.864720106124878,5.729430198669434",
                    }}
                  />
                  <path
                  ...
                  <path
                    ...
                    style={{ fill: "#e7bfaa" }}
                  />
                  <path d="M82.48,92.92c-1.25,3.55-13,7.67-13,7.67s35.57,40.73,49.3,40.47-6-38.4-6-38.4-4-2-5.25-5.88,1.37-20.54,1.37-20.54L94.39,67.37S83.73,89.37,82.48,92.92Z" />
                  <path
          ...
          <div className="sm:w-5/12 xl:w-4/12 flex flex-col items-start sm:items-end sm:text-right ml-auto mt-8 sm:mt-0 relative z-10 xl:pt-20 mb-16 sm:mb-0">
            ...
            <p className="lg:text-lg mb-4 sm:mb-12 dark:text-white  ">
              Lorem ipsum dolor sit amet, consectetur adipiscing adipiselit. Pellentesque
              suscipit tellus vitae purus dignissim, nec tincidunt neque condimentum. Nam
              nec ligula pretium mi interdum hendrerit in sit.
            </p>
            <a
              href="#"
