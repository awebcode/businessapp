  ...
  return (
    <div className="wrapper">
      <div className="main-container">
        <h2 className="mb-4 text-center text-3xl font-bold  md:mb-8 lg:text-3xl">
          Login
        </h2>

        <form className="mx-auto max-w-lg rounded-lg border dark:border-gray-500">
          <div className="flex flex-col gap-4 p-4 md:p-8">
            <div>
              <label htmlFor="email" className="mb-2 inline-block text-sm  sm:text-base">
                Email
              </label>
              <input
                name="email"
                className="w-full rounded border bg-gray-50 dark:bg-black dark:text-white px-3 py-2  outline-none ring-indigo-300 transition duration-100 focus:ring"
              />
            </div>
            ...
            <div>
              ...
              <input
                name="password"
                className="w-full rounded border bg-gray-50 dark:bg-black dark:text-white px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"
              />
            </div>
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="relative bg-white dark:bg-gray-950 dark:text-white px-4 text-sm text-gray-400">
                Log in with social
              </span>
            </div>
